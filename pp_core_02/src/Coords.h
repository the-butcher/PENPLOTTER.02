...
class Coords {
   private:
    ...
    static block_planxy_i64_t blockBufferPlanxy[BLOCK_BUFFER_SIZE];

   public:
    static bool begin();
    static block_planxy_i64_t popBlock();
    static bool hasBlock();
    static bool addBlock(block_planxy_i64_t blockPlanxy);
    /**
     ...
     */
    static coord_corexy_____t planxyToCorexy(coord_planxy_i64_t& coordPlanxy);
    static coord_corexy_____t planxyToCorexy(block_planxy_i64_t& blockPlanxy);
    static coord_planxy_i64_t corexyToPlanxy(coord_corexy_____t& coordCorexy);

    static coord_corexy_____t toCorexyVector(coord_corexy_____t& srcCorexy, coord_corexy_____t& dstCorexy);
    static coord_planxy_i64_t toPlanxyVector(coord_planxy_i64_t& srcPlanxy, block_planxy_i64_t& dstPlanxy);
