...
class Coords {
   private:
    ...
    static block_planxy_d___t blockBufferPlanxy[BLOCK_BUFFER_SIZE];

   public:
    static bool begin();
    static block_planxy_d___t popBlock();
    static bool hasBlock();
    static bool addBlock(block_planxy_d___t blockPlanxy);
    /**
    ...
    // static block_device_____t toDeviceBlock(coord_planxy_d___t& srcPlanxy, block_planxy_d___t& dstPlanxy);
     ...
     */
    static coord_corexy_____t planxyToCorexy(coord_planxy_d___t& coordPlanxy);
    static coord_corexy_____t planxyToCorexy(block_planxy_d___t& blockPlanxy);
    static coord_planxy_d___t corexyToPlanxy(coord_corexy_____t& coordCorexy);

    static coord_corexy_____t toCorexyVector(coord_corexy_____t& srcCorexy, coord_corexy_____t& dstCorexy);
    static coord_planxy_d___t toPlanxyVector(coord_planxy_d___t& srcPlanxy, block_planxy_d___t& dstPlanxy);

    // static double toLength(coord_planxy_d___t& coordPlanxy);
};
