...
block_planxy_d___t Coords::blockBufferPlanxy[BLOCK_BUFFER_SIZE];
...
block_planxy_d___t Coords::popBlock() {
    return Coords::blockBufferPlanxy[Coords::nextBlockIndex++ % BLOCK_BUFFER_SIZE];
}

bool Coords::addBlock(block_planxy_d___t dstPlanxy) {
    Coords::blockBufferPlanxy[Coords::blockIndex % BLOCK_BUFFER_SIZE] = dstPlanxy;
    Coords::blockIndex++;
    return true;
}
...
coord_corexy_____t Coords::planxyToCorexy(coord_planxy_d___t& coordPlanar) {
...
coord_corexy_____t Coords::planxyToCorexy(block_planxy_d___t& blockPlanar) {
...
coord_planxy_d___t Coords::corexyToPlanxy(coord_corexy_____t& coordCorexy) {
...
coord_planxy_d___t Coords::toPlanxyVector(coord_planxy_d___t& srcPlanxy, block_planxy_d___t& dstPlanxy) {
    return {dstPlanxy.x - srcPlanxy.x, dstPlanxy.y - srcPlanxy.y, dstPlanxy.z - srcPlanxy.z};
}

// double Coords::toLength(coord_planxy_d___t& coordPlanxy) {
